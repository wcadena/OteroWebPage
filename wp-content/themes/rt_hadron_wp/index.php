...
global $gantry;
/** agregado por wcadena */
require_once "class/url.php";
$url=new Url(get_bloginfo('home'));
//print_r($url);
$page=$url->get_seccion(1);
/** finagreado wcadena */
...
<body <?php echo $gantry->displayBodyTag(); ?>>
	<div id="rt-page-surround">
		...
		<?php
		//echo '------------------------------.>'.$page;
		if($page<>'cabecerakatana'){/**aumentado por wcadena codigo 11w1w1sadaelokjaiag ini*/
		?>
...
<?php	} /**aumentado por wcadena codigo 11w1w1sadaelokjaiag fin*/			?>
<?php
$gantry->finalize();
?>