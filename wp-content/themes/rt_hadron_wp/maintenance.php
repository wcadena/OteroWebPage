		...
		<div id="rt-page-surround">
			...
			<section id="rt-authorized-form">
				...
				<p class="rt-authorized-login-message">
					<?php _re(' When your site is in Maintenance mode, the site frontend will not be available for public. You can still access the frontend of the site by logging in as an administrator below. You can customize this message in the Hadron theme language file.'); ?>
				</p>				
