...
<form class="form-horizontal" role="form" method="post" action="index.php?action=addcategory">
  ...
  <div class="form-group">
    ...
    <div class="form-group">
        <label for="inputEmail1" class="col-lg-2 control-label">Tipo Categoria</label>
        <div class="col-lg-10">
            <select class="form-control" name="tipocategoria" placeholder="Eventos o Productos">
...
<form class="form-horizontal" role="form" method="post" action="index.php?action=updatecategory">
  ...
  <div class="form-group">
    ...
    <div class="form-group">
        <label for="inputEmail1" class="col-lg-2 control-label">Tipo Categoria</label>
        <div class="col-lg-10">
            <select class="form-control" name="tipocategoria" placeholder="Productos y Eventos">
                <option value="1" <?php if ( $cat->tipocategoria == 1 ) echo 'selected="selected"'; ?> >Producto</option>
                <option value="2" <?php if ( $cat->tipocategoria == 2 ) echo 'selected="selected"'; ?> >Evento</option>
            </select>
        </div>
    </div>
