...
<html lang="en">
  <head>
    ...
    <title>.: Admin Katana PRO v3.8 :.</title>
    ...
    <div id="wrapper">
      ...
      <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
        ...
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="./">KATANA PRO <sup><small><span class="label label-primary">v3.8</span></small></sup> </a>
        </div>
...
?>
         <ul class="nav navbar-nav">
          ...
          <li><a href="index.php?view=coupons"><i class="fa fa-ticket"></i> Cupones</a></li>
          ...
          <li><a href="index.php?view=calendariot"><i class="fa fa-calendar"></i> Calendario</a></li>
