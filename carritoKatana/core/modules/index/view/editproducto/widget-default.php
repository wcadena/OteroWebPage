        ...
        <div class="col-md-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body ">
                    <form class="form-horizontal" role="form" enctype="multipart/form-data" method="post" action="index.php?action=updateproducto">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-10">
                                <?php
                                $categories = CategoryData::getCategorias();
                                if(count($categories)>0):?>
                        ...
                        <!--WCADENA --><input class="form-control" type="hidden" name="fecha_fin_evento" id="fecha_fin_evento" placeholder="yyyy-mm-dd hh:mm:ss"  value="<?php echo $product->fecha_fin_evento; ?>" />
                        <input class="form-control" type="hidden" name="fecha_ini_evento"  id="fecha_ini_evento" placeholder="yyyy-mm-dd hh:mm:ss"  value="<?php echo $product->fecha_ini_evento; ?>" />
