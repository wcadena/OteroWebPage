        ...
        <div class="col-md-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body ">
                    ...
                    <form class="form-horizontal" role="form" method="post" enctype="multipart/form-data" action="index.php?action=addSoloProducto">
                        ...
                        <!--WCADENA --><input class="form-control" type="hidden" name="fecha_fin_evento" id="fecha_fin_evento" placeholder="yyyy-mm-dd hh:mm:ss" value="0" />
                        <input class="form-control" type="hidden" name="fecha_ini_evento"  id="fecha_ini_evento" placeholder="yyyy-mm-dd hh:mm:ss"  value="0" />
